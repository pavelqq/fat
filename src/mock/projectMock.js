...
// mock.onGet('/api/project/2/diet/products').reply(200, {
//     products: [
//         {
//             id: uuidv4(),
//             name: 'Рис',
